...
IL_022f:
	{
		...
		Vector3__ctor_m57495F692C6CE1CEF278CAD9A98221165D37E636_inline((&L_60), (0.0f), (-0.0599999987f), (0.0f), /*hidden argument*/NULL);
		NullCheck(L_59);
		Rigidbody_AddForce_m78B9D94F505E19F3C63461362AD6DE7EA0836700(L_59, L_60, 1, /*hidden argument*/NULL);
		// if (itemArray[i].transform.position.y < bottomLeft.y && itemArray[i].activeSelf)
		GameObjectU5BU5D_tA88FC1A1FC9D4D73D0B3984D4B0ECE88F4C47642* L_61 = __this->get_itemArray_11();
		int32_t L_62 = V_3;
		NullCheck(L_61);
		int32_t L_63 = L_62;
	...
	{
		GameObjectU5BU5D_tA88FC1A1FC9D4D73D0B3984D4B0ECE88F4C47642* L_70 = __this->get_itemArray_11();
		int32_t L_71 = V_3;
		NullCheck(L_70);
		int32_t L_72 = L_71;
		...
		NullCheck(L_73);
		bool L_74;
		L_74 = GameObject_get_activeSelf_m4865097C24FB29F3C31F5C30619AF242297F23EE(L_73, /*hidden argument*/NULL);
		if (!L_74)
		{
			goto IL_02a4;
		}
	}
	{
		...
		GameObjectU5BU5D_tA88FC1A1FC9D4D73D0B3984D4B0ECE88F4C47642* L_75 = __this->get_itemArray_11();
		int32_t L_76 = V_3;
		NullCheck(L_75);
		int32_t L_77 = L_76;
		GameObject_tC000A2E1A7CF1E10FD7BA08863287C072207C319 * L_78 = (L_75)->GetAt(static_cast<il2cpp_array_size_t>(L_77));
		MaterialU5BU5D_t3AE4936F3CA08FB9EE182A935E665EA9CDA5E492* L_79 = __this->get_foodMat_17();
		Material_t8927C00353A72755313F046D0CE85178AE8218EE * L_80 = __this->get_salmon_18();
		RuntimeObject* L_81;
		L_81 = Environment_RespawnFood_mD9D718BCEF7F29BA515E1CC39D10DB3C532F288B(L_78, L_79, L_80, /*hidden argument*/NULL);
...
IL_02a8:
	{
		// for (int i = 0; i < numOfItems; i++)
		int32_t L_84 = V_3;
		int32_t L_85 = __this->get_numOfItems_9();
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR void Environment2_Update_m432EFDA7E7A8E8EA1EE8CDC08AD11509494B2350 (Environment2_t1C29D7F062C89C6466D2ABB451A4A5EE0561996C * __this, const RuntimeMethod* method)
{
	...
	int32_t V_2 = 0;
	{
		...
		Vector3__ctor_m57495F692C6CE1CEF278CAD9A98221165D37E636_inline((&L_15), ((float)((float)((int32_t)((int32_t)L_12/(int32_t)2)))), ((float)((float)((int32_t)((int32_t)L_14/(int32_t)2)))), (1.29999995f), /*hidden argument*/NULL);
		NullCheck(L_10);
...
IL_008c:
	...
	}
	{
		...
		// gameover.Play();
		AudioSource_tC4BF65AF8CDCAA63724BB3CA59A7A29249269E6B * L_31 = __this->get_gameover_7();
		NullCheck(L_31);
		...
		RuntimeObject* L_36;
		L_36 = Environment2_RespawnFood_m011FCFFB82DB6DE02954E7DCE0882443BE8C1BD0(L_33, L_34, L_35, /*hidden argument*/NULL);
...
IL_00e4:
	...
	}
	{
		...
		// pickup1.Play();
		AudioSource_tC4BF65AF8CDCAA63724BB3CA59A7A29249269E6B * L_43 = __this->get_pickup1_6();
		NullCheck(L_43);
		AudioSource_Play_mED16664B8F8F3E4D68785C8C00FC96C4DF053AE1(L_43, /*hidden argument*/NULL);
		// StartCoroutine(Environment2.RespawnFood(collision.gameObject, foodMat, salmon));
		Collision_tDC11F9B3834FD25DEB8C7DD1C51B635D240BBBF0 * L_44 = ___collision0;
		NullCheck(L_44);
		GameObject_tC000A2E1A7CF1E10FD7BA08863287C072207C319 * L_45;
		L_45 = Collision_get_gameObject_m5682F872FD28419AA36F0651CE8B19825A21859D(L_44, /*hidden argument*/NULL);
		...
		RuntimeObject* L_48;
		L_48 = Environment2_RespawnFood_m011FCFFB82DB6DE02954E7DCE0882443BE8C1BD0(L_45, L_46, L_47, /*hidden argument*/NULL);
