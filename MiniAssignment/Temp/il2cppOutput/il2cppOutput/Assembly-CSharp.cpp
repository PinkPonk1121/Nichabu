...
IL2CPP_EXTERN_C String_t* _stringLiteralE46D6E7E6C129DE428834F33E0BAA58B113DC095;
...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR ValueTuple_2_tE50F6629065DA246B491DBE066203C9E8C7A8C3C  Environment_cameraDepth_mE976BC680A3D6872872EC1B588DFED02B2B2994D (const RuntimeMethod* method)
{
	...
	if (!s_Il2CppMethodInitialized)
	{
		...
		il2cpp_codegen_initialize_runtime_metadata((uintptr_t*)&_stringLiteralE46D6E7E6C129DE428834F33E0BAA58B113DC095);
		s_Il2CppMethodInitialized = true;
	}
	Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E  V_0;
	memset((&V_0), 0, sizeof(V_0));
	...
	Enumerator_t7E354D6B9B56BAD9140257DC4FB6BFA31D72D759  V_5;
	memset((&V_5), 0, sizeof(V_5));
	TrackableCollection_1_t7D19C681EB73C0FB05934E893379C87379845C93  V_6;
	memset((&V_6), 0, sizeof(V_6));
	ARFace_t7EC7B3979551DCD92E4C51D35BD9664F44CE86E1 * V_7 = NULL;
	Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E  V_8;
	memset((&V_8), 0, sizeof(V_8));
	{
		...
		L_5 = TrackableCollection_1_GetEnumerator_m40F6719236F0DFDFEAE463E8EFD1016E8F3F4F3D((TrackableCollection_1_t7D19C681EB73C0FB05934E893379C87379845C93 *)(&V_6), /*hidden argument*/TrackableCollection_1_GetEnumerator_m40F6719236F0DFDFEAE463E8EFD1016E8F3F4F3D_RuntimeMethod_var);
		V_5 = L_5;
		goto IL_009b;
	}
...
IL_0043:
	{
		...
		L_6 = Enumerator_get_Current_m8A77EC72EA201FF6350A11DC1DABE9A6397109F6((Enumerator_t7E354D6B9B56BAD9140257DC4FB6BFA31D72D759 *)(&V_5), /*hidden argument*/Enumerator_get_Current_m8A77EC72EA201FF6350A11DC1DABE9A6397109F6_RuntimeMethod_var);
		V_7 = L_6;
		// if (pot == null){
	...
	}
	{
		...
		ARFace_t7EC7B3979551DCD92E4C51D35BD9664F44CE86E1 * L_9 = V_7;
		NullCheck(L_9);
...
IL_0065:
	{
		...
		ARFace_t7EC7B3979551DCD92E4C51D35BD9664F44CE86E1 * L_11 = V_7;
		NullCheck(L_11);
		...
		V_8 = L_13;
		String_t* L_14;
		L_14 = Vector3_ToString_mD5085501F9A0483542E9F7B18CD09C0AB977E318((Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E *)(&V_8), /*hidden argument*/NULL);
		String_t* L_15;
		L_15 = String_Concat_m4B4AB72618348C5DFBFBA8DED84B9E2EBDB55E1B(_stringLiteralE46D6E7E6C129DE428834F33E0BAA58B113DC095, L_14, /*hidden argument*/NULL);
		V_2 = L_15;
...
IL_009b:
	{
		// foreach (ARFace face in faceManager.trackables)
		bool L_19;
		L_19 = Enumerator_MoveNext_m87B7AD3E2817B33455C9F63CF5A60EE67B941FC2((Enumerator_t7E354D6B9B56BAD9140257DC4FB6BFA31D72D759 *)(&V_5), /*hidden argument*/Enumerator_MoveNext_m87B7AD3E2817B33455C9F63CF5A60EE67B941FC2_RuntimeMethod_var);
		if (L_19)
		{
			goto IL_0043;
		}
	}
	{
		...
		float L_28;
		L_28 = Vector3_get_magnitude_mDDD40612220D8104E77E993E18A101A69A944991((Vector3_t65B972D6A585A0A5B63153CF1177A90D3C90D65E *)(&V_4), /*hidden argument*/NULL);
		// return (depth, facePos);
		String_t* L_29 = V_2;
		ValueTuple_2_tE50F6629065DA246B491DBE066203C9E8C7A8C3C  L_30;
		memset((&L_30), 0, sizeof(L_30));
		ValueTuple_2__ctor_m3FEF4A022BB1951074CF2AAC552CDE3D348BEF20((&L_30), L_28, L_29, /*hidden argument*/ValueTuple_2__ctor_m3FEF4A022BB1951074CF2AAC552CDE3D348BEF20_RuntimeMethod_var);
		return L_30;
	}
}
